...
// FUSE bits  /home/beaver/dude/avrdude-5.10/avrdude -c ftbb -p t2313 -P /dev/ttyUSB1 -B 9600 -U hfuse:w:0xdf:m -U lfuse:w:0x64:m
// /home/beaver/dude/avrdude-5.10/avrdude -c ftbb -p t2313 -P /dev/ttyUSB1 -B 9600 -U hfuse:r:hf.txt:i -U lfuse:r:lf.txt:i
// /home/beaver/dude/avrdude-5.10/avrdude -c ftbb -p t2313 -P /dev/ttyUSB1 -B 9600 -U hfuse:w:hf.txt:h -U lfuse:w:lf.txt:h
...
unsigned char   up[16]={0,RED,RED+GREEN,GREEN,GREEN+BLUE,BLUE,BLUE+RED,RED+GREEN+BLUE, 0, 0, 0, 0, 0, 0, 0, 0};
unsigned char down[16]={0,RED,RED+GREEN,GREEN,GREEN+BLUE,BLUE,BLUE+RED,RED+GREEN+BLUE, 0, 0, 0, 0, 0, 0, 0, 0};
